...
const Footer = () => {
  ...
  return (
    <footer className="bg-transparent text-foreground border-t border-foreground/20 mt-30 py-10 px-4 sm:px-6 lg:px-8 text-sm">
      ...
      {/* Bottom */}
      <div className="max-w-7xl mx-auto border-t border-foreground/20 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-muted-foreground">
